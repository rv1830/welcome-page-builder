...
const Signup = () => {
  const benefits = ["14-day free trial", "No credit card required", "Full feature access"];
    ...
    <div className="min-h-screen flex">
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-12">
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="text-muted-foreground mb-8">Start your 14-day free trial today</p>
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input id="password" type="password" placeholder="8+ characters" className="pl-10" />
              </div>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-muted items-center justify-center p-12">
        <div className="max-w-md">
          ...
          <h2 className="text-2xl font-bold mb-4">Start selling smarter today</h2>
          <p className="text-muted-foreground mb-6">Join 2,000+ sales teams using LAPS to automate their pipeline.</p>
